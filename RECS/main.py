...
class Application:
    ...
    def go_to_second_page(self):
        ...
        if self.transport_type.get() == "Main railway 3 kV DC" and self.type_of_calculation.get() == "Substation":
            ...
            self.window = railwaytractionpage(self.type_of_calculation.get())
        elif self.transport_type.get() == "Main railway 3 kV DC" and self.type_of_calculation.get() == "Short circuit":
            self.window = railwayshortcircuitpage(self.type_of_calculation.get())
...
# Calculation algorithm
    ...
    def show_result(self):
        ...
        result_a = [round(num, 2) for num in self.calculation_a()]
        ...
        result_b, result_b_1, result_b_2, result_b_3 = self.calculation_b()
...
class pageforrailwayshortcircuit:
    def __init__(self, type_of_calculation):
        self.window = tk.Tk()
...
class TrainPage(TransportPageForTrain):
    def __init__(self, type_of_calculation):
        super().__init__(type_of_calculation)

class railwaytractionpage(pageforrailwaytraction):
    def __init__(self, type_of_calculation):
        super().__init__(type_of_calculation)

class railwayshortcircuitpage(pageforrailwayshortcircuit):
    def __init__(self, type_of_calculation):
        super().__init__(type_of_calculation)
